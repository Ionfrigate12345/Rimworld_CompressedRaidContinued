...
namespace CompressedRaid
{
    ...
    public class CompressedRaidMod : Mod
    {
        ...
        private string mapGeneratedEnemyMainColonyThreatMinimumBuffer = null;
        private string mapGeneratedEnemyMainColonyThreatPerStatPercentageBuffer = null;
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            Widgets.DrawLineHorizontal(inRect.x, inRect.y + UIUtility.HEIGHT_HEADER, inRect.width);
        ...
        private void EditCommonSection(Rect inRect, ref bool valueChanged)
        {
            ...
            Rect labelRect = new Rect(inRect.x + UIUtility.MARGIN_LEFT, inRect.y + marginTop, inRect.width, UIUtility.HEIGHT_ROW);
            Widgets.CheckboxLabeled(labelRect, "CR_EnableMapGeneratedEnemyEnhanced".Translate(), ref m_Settings.mapGeneratedEnemyEnhanced);
            marginTop += UIUtility.HEIGHT_ROW;

            if (m_Settings.mapGeneratedEnemyEnhanced)
            {
                Rect labelMapGeneratedEnemyMainColonyThreatMinimum = new Rect(inRect.x + UIUtility.MARGIN_LEFT, inRect.y + marginTop, 500f, UIUtility.HEIGHT_ROW);
                Widgets.Label(labelMapGeneratedEnemyMainColonyThreatMinimum, "CR_MapGeneratedEnemyMainColonyThreatMinimum_Label".Translate());
                Rect inputMapGeneratedEnemyMainColonyThreatMinimum = new Rect(inRect.x + UIUtility.MARGIN_LEFT + UIUtility.WIDTH_THREE_QUARTERS_HALF + (UIUtility.INPUT_WIDTH_MIN * 3f), inRect.y + marginTop, 80f, UIUtility.HEIGHT_ROW);
                Widgets.TextFieldNumeric(inputMapGeneratedEnemyMainColonyThreatMinimum, ref m_Settings.mapGeneratedEnemyMainColonyThreatMinimum, ref mapGeneratedEnemyMainColonyThreatMinimumBuffer, 0);
                marginTop += UIUtility.HEIGHT_ROW;

                Rect labelMapGeneratedEnemyMainColonyThreatPerStatPercentage = new Rect(inRect.x + UIUtility.MARGIN_LEFT, inRect.y + marginTop, 500f, UIUtility.HEIGHT_ROW);
                Widgets.Label(labelMapGeneratedEnemyMainColonyThreatPerStatPercentage, "CR_MapGeneratedEnemyMainColonyThreatPerStatPercentage".Translate());
        ...
        public CompressedRaidModSettings CRModSettings { get { return this.m_Settings; } }
