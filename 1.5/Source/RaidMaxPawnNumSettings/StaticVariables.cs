...
namespace CompressedRaid
{
    public static class StaticVariables
    {
        ...
        static StaticVariables()
        {
            ...
            m_DefaultValues["mapGeneratedEnemyEnhanced"] = MAP_GENERATED_ENEMY_ENHANCED;
            m_DefaultValues["mapGeneratedEnemyMainColonyThreatPerStatPercentage"] = MAP_GENERATED_ENEMY_MAINCOLONY_THREAT_PER_STAT_PERCENTAGE;
            m_DefaultValues["mapGeneratedEnemyMainColonyThreatMinimum"] = MAP_GENERATED_ENEMY_MAINCOLONY_THREAT_MINIMUM;
        }
