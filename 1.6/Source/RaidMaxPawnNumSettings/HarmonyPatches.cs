    ...
    public class HarmonyPatches
    {
        ...
        private static void ManualSafePatch(Harmony harmony)
        {
            ...
            else
            {
                ...
                {
                    harmony.Patch(method,
                        new HarmonyMethod(typeof(ManhunterPackIncidentUtility_Patch), nameof(ManhunterPackIncidentUtility_Patch.GenerateAnimals_Prefix), new Type[] { typeof(List<Pawn>).MakeByRefType(), typeof(PawnKindDef), typeof(PlanetTile), typeof(float), typeof(int) }) { methodType = MethodType.Normal });
